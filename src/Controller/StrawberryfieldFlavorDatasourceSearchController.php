...
class StrawberryfieldFlavorDatasourceSearchController extends ControllerBase {
     ...
     */
    public function search(Request $request, ContentEntityInterface $node, string $fileuuid = 'all', string $processor = 'ocr', string $format = 'json', string $page = 'all', int $limit = 100) {
